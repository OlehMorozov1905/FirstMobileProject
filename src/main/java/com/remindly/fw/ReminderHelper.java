...
public class ReminderHelper extends BaseHelper{
    ...
    public void tapOnToggleSwitch() {
        tap(By.id("repeat_switch"));
    }
    public void tapOnRepetitionIntervalField() {
        tap(By.id("RepeatNo"));
    }
    public void enterIntervalIndex(String index) {
        pause(500);
        type(By.className("android.widget.EditText"), index);
    }
    ...
    public void tapOnTypeOfRepetitionsField() {
        tap(By.id("RepeatType"));
    }
    public void selectMinutes() {
        pause(500);
        tapWithCoordinates(210, 700);
    }
}